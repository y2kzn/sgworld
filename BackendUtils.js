...
class UserModel {
  ...
  static async create(deviceId, platformData = {}) {
    ...
    const username = `.gg/sgworld<color=orange><sup>#${userId}`;
  ...
  static tournaments = [
    {
      ...
      nameKey: "(.gg/sgworld) Block Dash 1v1",
      descriptionKey: "Practice your skills in the Stumble World TournamentX! mode!",
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "(.gg/sgworld) Block Dash Legendary 1v1",
      descriptionKey: "Practice your skills in the Stumble World TournamentX! mode!",
